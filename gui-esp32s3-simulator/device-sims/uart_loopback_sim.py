        ...
        if method == "get_capabilities":
            return {
                ...
                "panel": {
                    "kind": "uart",
                    "controls": [
                        {"name": "baud", "type": "int", "min": 300, "max": 5_000_000, "writable": True},
                        {"name": "data_bits", "type": "enum", "enum": [5, 6, 7, 8], "writable": True},
                        {"name": "parity", "type": "enum", "enum": ["none", "even", "odd"], "writable": True},
                        {"name": "stop_bits", "type": "enum", "enum": [1, 1.5, 2], "writable": True},
                        {"name": "flow_control", "type": "enum", "enum": ["none", "rtscts", "xonxoff"], "writable": True},
                        {"name": "fifo_depth", "type": "int", "min": 1, "max": 1024, "writable": True},
                        {"name": "reset_counters", "type": "action"},
                    ],
                },
                "transports": ["uart"],
                "uart": {
